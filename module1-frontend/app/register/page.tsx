    ...
    <AppShell>
      <div className="mx-auto max-w-lg py-8">
        ...
        <form className="card mt-8" onSubmit={handleSubmit} noValidate>
          ...
          <input className="form-input" id="password" type="password" autoComplete="new-password" minLength={8} required value={password} onChange={(event) => setPassword(event.target.value)} />
