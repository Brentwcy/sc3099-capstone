      ...
      <AppShell>
        <div className="mx-auto max-w-4xl">
          ...
          <section className="card mt-8">
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">Face enrollment is the next milestone</h1>
            <p className="mt-3 max-w-2xl leading-7 text-slate-600">The camera capture and mock enrollment service have intentionally not been bundled into the consent change. You can leave setup now and return when face enrollment is available.</p>
            {!consentComplete && (
